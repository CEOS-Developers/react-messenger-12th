...
const FOLLOWERSLIST = [
  ...
  {
    img:'https://i.pinimg.com/originals/ed/d8/75/edd875f1fd33a8e6cf46c30b7bebc517.jpg',
    id: 'abcddf',
    name: '빈빈빈',
  },
];

export default function InstaDMScreen() {
  ...
  useEffect(() => {
    setFilteredFollowers(
      followersList.filter((followers) => {
        ...
        return (followers.id.toLowerCase().includes(search.toLowerCase())||followers.name.toLowerCase().includes(search.toLowerCase()));
      })
    );
